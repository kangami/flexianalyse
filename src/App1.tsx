...
// SUPPRIMÉ: Tous les imports OpenAI et LangChain
...
const App1: React.FC = () => {
  ...
  // SUPPRIMÉ: vectorStore et lastIndexedFilesRef
  ...
  const apiUrl = 'http://127.0.0.1:5000'; // 'https://flexianalyse.com';
  ...
  // FONCTION MODIFIÉE: handleQuerySubmit
